...
3. Creați un folder numit `boot9strap` pe rădăcina cardului SD
4. Copiați `boot9strap.firm` și `boot9strap.firm.sha` din arhiva `.zip` boot9strap în folderul `/boot9strap/` de pe cardul SD
...
6. Dacă exploit-ul a avut succes, veți porni în SafeB9SInstaller
