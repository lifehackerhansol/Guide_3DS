...
3. Создайте папку `boot9strap` в корне SD-карты
4. Скопируйте `boot9strap.firm` и `boot9strap.firm.sha` из `.zip-архива` boot9strap в папку `/boot9strap/` в корне SD-карты
...
6. Если эксплойт сработал, запустится SafeB9SInstaller
