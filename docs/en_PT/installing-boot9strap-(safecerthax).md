...
3. Create a folder named `boot9strap` on th' root 'o ye SD card
4. Copy `boot9strap.firm` 'n `boot9strap.firm.sha` from th' boot9strap `.zip` to th' `/boot9strap/` folder on ye SD card
